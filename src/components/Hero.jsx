...
const Hero = () => {
  return (
    <section className='w-full h-screen relative mx-auto'>
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl flex flex-row gap-5 items-start`}>
        <div className="flex flex-col justify-center items-center">
            <div className='h-5 w-5 bg-[#915eff] rounded-full' />
            <div className='w-1 sm:h-80 h-48 violet-gradient' />
        </div>
        <div>
          <h1 className={`${styles.heroHeadText} text-white`}>Hi, I'm <span className='text-[#915eff]'>Muneeb Rana</span></h1>
